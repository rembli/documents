...
function writeFilesToTable () {
	...
	for(var i = 0; i < fileInfos.length; i++) {
		...
		window.document.write ("<td><a href='"+host+"/api/documents/"+getParameterByName("id")+"/files/"+fileInfo.idFile+"' target='_new'><img src='"+host+"/api/documents/"+getParameterByName("id")+"/files/"+fileInfo.idFile+"/thumbnail' onError='this.src = \"./img/thumbnail_not_available.jpg\"'></a>");		
